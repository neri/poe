...
impl UsageLong {
    ...
    #[inline]
    pub const fn page_u16(&self) -> u16 {
    ...
    #[inline]
    pub const fn usage(&self) -> UsageShort {
        UsageShort(self.0.get() as u16)
    }

    #[inline]
    pub const fn generic(usage: u16) -> Self {
        Self::new(UsagePage::GENERIC_DESKTOP, UsageShort(usage))
    }

    #[inline]
    pub const fn button(usage: u16) -> Self {
        Self::new(UsagePage::BUTTON, UsageShort(usage))
    }

    #[inline]
    pub const fn consumer(usage: u16) -> Self {
        Self::new(UsagePage::CONSUMER, UsageShort(usage))
    }

    #[inline]
    pub const fn digitizers(usage: u16) -> Self {
        Self::new(UsagePage::DIGITIZERS, UsageShort(usage))
    }

    #[inline]
    pub const fn led(usage: u16) -> Self {
        Self::new(UsagePage::LED, UsageShort(usage))
    }
}

impl core::fmt::Debug for UsageLong {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "{:04x}_{:04x}", self.page_u16(), self.usage().0)
    }
}

impl core::fmt::Display for UsageLong {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "{:04x}_{:04x}", self.page_u16(), self.usage().0)
    }
}
...
impl Usage {
    ...
    pub const ERR_ROLL_OVER: Self = Self(0x01);
    pub const ERR_POST_FAIL: Self = Self(0x02);
    pub const ERR_UNDEFINED: Self = Self(0x03);
    ...
    #[inline]
    pub const fn full_qualified_usage(&self) -> UsageLong {
        UsageLong::new(UsagePage::KEYBOARD, UsageShort(self.0 as u16))
    }
}

impl From<Usage> for UsageLong {
    #[inline]
...
impl MouseButton {
    ...
    /// Tertiary Button (typically the middle button)
...
impl HidReportLeadByte {
    ...
    pub fn item_tag(&self) -> Option<HidReportItemTag> {
        HidReportItemTag::from_u8(self.0 & 0xfc)
    }
}
...
impl HidReportItemTag {
    #[inline]
    pub fn from_u8(value: u8) -> Option<Self> {
        match value {
            0x80 => Some(Self::Input),
            0x90 => Some(Self::Output),
            0xB0 => Some(Self::Feature),
            0xA0 => Some(Self::Collection),
            0xC0 => Some(Self::EndCollection),
            0x04 => Some(Self::UsagePage),
            0x14 => Some(Self::LogicalMinimum),
            0x24 => Some(Self::LogicalMaximum),
            0x34 => Some(Self::PhysicalMinimum),
            0x44 => Some(Self::PhysicalMaximum),
            0x54 => Some(Self::UnitExponent),
            0x64 => Some(Self::Unit),
            0x74 => Some(Self::ReportSize),
            0x84 => Some(Self::ReportId),
            0x94 => Some(Self::ReportCount),
            0xA4 => Some(Self::Push),
            0xB4 => Some(Self::Pop),
            0x08 => Some(Self::Usage),
            0x18 => Some(Self::UsageMinimum),
            0x28 => Some(Self::UsageMaximum),
            0x38 => Some(Self::DesignatorIndex),
            0x48 => Some(Self::DesignatorMinimum),
            0x58 => Some(Self::DesignatorMaximum),
            0x78 => Some(Self::StringIndex),
            0x88 => Some(Self::StringMinimum),
            0x98 => Some(Self::StringMaximum),
            0xA8 => Some(Self::Delimiter),
            _ => None,
        }
    }
}
...
impl NonZeroUsageShort {
    #[inline]
    pub const fn get(&self) -> UsageShort {
        UsageShort(self.0.get())
    }
...
impl Deref for NonZeroUsageShort {
    type Target = UsageShort;
