...
const USAGE_TO_SHIFT: [u8; 128] = [
    ...
    /* 2- */ b'#', b'$', b'%', b'^', b'&', b'*', b'(', b')', 0x0d, 0x1b, 0x7f, b'\t', b' ', b'_', b'+', b'{',
    /* 3- */ b'}', b'|', b'|', b':', b'"', b'~', b'<', b'>', b'?', 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const CHAR_TO_KEYSTROKE: [(Usage, Modifier); 128] = [
    ...
    (Usage(0x31), Modifier::LEFT_CTRL),        // 0x1c
    (Usage(0x30), Modifier::LEFT_CTRL),        // 0x1d
    (Usage::KEY_6, Modifier::LEFT_CTRL),       // 0x1e
    (Usage(0x2d), Modifier::LEFT_CTRL),        // 0x1f
    (Usage::KEY_SPACE, Modifier::empty()),     // 0x20
    (Usage::KEY_1, Modifier::LEFT_SHIFT),      // 0x21
    (Usage(0x34), Modifier::LEFT_SHIFT),       // 0x22
    (Usage::KEY_3, Modifier::LEFT_SHIFT),      // 0x23
    (Usage::KEY_4, Modifier::LEFT_SHIFT),      // 0x24
    (Usage::KEY_5, Modifier::LEFT_SHIFT),      // 0x25
    (Usage::KEY_7, Modifier::LEFT_SHIFT),      // 0x26
    (Usage(0x34), Modifier::empty()),          // 0x27
    (Usage::KEY_9, Modifier::LEFT_SHIFT),      // 0x28
    (Usage::KEY_0, Modifier::LEFT_SHIFT),      // 0x29
    (Usage::KEY_8, Modifier::LEFT_SHIFT),      // 0x2a
    (Usage(0x2e), Modifier::LEFT_SHIFT),       // 0x2b
    ...
    (Usage(0x2f), Modifier::empty()),          // 0x5b
    (Usage(0x31), Modifier::empty()),          // 0x5c
    (Usage(0x30), Modifier::empty()),          // 0x5d
    (Usage::KEY_6, Modifier::LEFT_SHIFT),      // 0x5e
    (Usage(0x2d), Modifier::LEFT_SHIFT),       // 0x5f
    (Usage(0x35), Modifier::empty()),          // 0x60
    ...
    (Usage(0x2f), Modifier::LEFT_SHIFT),       // 0x7b
    (Usage(0x31), Modifier::LEFT_SHIFT),       // 0x7c
    (Usage(0x30), Modifier::LEFT_SHIFT),       // 0x7d
