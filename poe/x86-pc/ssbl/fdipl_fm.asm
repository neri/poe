;; Floppy Boot Sector for MEG-OS (alternative FM TOWNS version)
;; PUBLIC DOMAIN
;;
;; # MEMORY MAP
;;
...
_HEAD:
    db "IPL4"   ;; IPL signature for FM TOWNS
                ;; These are interpreted in other models as the following instructions:
                ;;   dec cx
                ;;   push ax
                ;;   dec sp
                ;;   xor al, ??
